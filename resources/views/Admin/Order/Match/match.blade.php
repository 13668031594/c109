                    ...
                    <fieldset class="layui-elem-field layui-field-title">
                        ...
                        <div class="layui-field-box">
                            <table class="layui-table">
                                ...
                                <tr>
                                    <td>帐号</td>
                                    <td>{{$self['sell_account']}}</td>
                                </tr>
                                <tr>
                                    <td>电话</td>
                                    <td>{{$self['sell_phone']}}</td>
                                </tr>
                                <tr>
                                    <td>昵称</td>
                                    <td>{{$self['sell_nickname']}}</td>
                                </tr>
                                <tr>
                                    <td>身份</td>
                                    <td>{{$grade[$self['sell_grade']]}}</td>
                                </tr>
                                <tr>
                                    <td>上级账号</td>
                                    <td>{{$self['sell_referee_account']}}</td>
                                </tr>
                                <tr>
                                    <td>上级昵称</td>
                                    <td>{{$self['sell_referee_nickname']}}</td>
                                </tr>
                                <!--<tr>
                                    <td>注册时间</td>
                                    <td>2016-11-28</td>
